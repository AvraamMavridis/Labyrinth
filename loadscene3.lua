...
local function onPlayBtnRelease()
	...
	storyboard.gotoScene( "scene3", "fade", 500 )
...
function scene:enterScene( event )
	...
	local wikiText=display.newText("Σύμφωνα με μια θεωρία, ο μύθος του Μινώταυρου σχετίζεται με\nτους μύθους των Βάαλ και Μολώχ των Φοινίκων.", 0, 0, "GFS Bodoni Rg", 14)
