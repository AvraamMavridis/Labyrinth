...
local function onPlayBtnRelease()
	...
	storyboard.gotoScene( "scene5", "fade", 500 )
...
function scene:enterScene( event )
	...
	local wikiText=display.newText("Yπάρχει η άποψη ότι ο μύθος της θανάτωσης του Μινώταυρου \nσυμβολίζει την απελευθέρωση των Ελλήνων από την \nκυριαρχία της Μινωικής Κρήτης.", 0, 0, "GFS Bodoni Rg", 14)
