...
local function onPlayBtnRelease()
	...
	storyboard.gotoScene( "scene7", "fade", 500 )
...
function scene:enterScene( event )
	...
	local wikiText=display.newText("Για το μύθο του Μινώταυρου έχουν γράψει οι αρχαίοι\nσυγγραφείς Πλούταρχος, Απολλόδωρος, Βιργίλιος και άλλοι.", 0, 0, "GFS Bodoni Rg", 14)
